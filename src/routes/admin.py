...
from utils import hash_password, verify_password, create_access_token, decode_access_token, email_verification, password_reset 
...
async def change_password(payload: PasswordChange):
    ...
    admin_collection.update_one({"email": email}, {"$set": {"password": hashed_password}})
